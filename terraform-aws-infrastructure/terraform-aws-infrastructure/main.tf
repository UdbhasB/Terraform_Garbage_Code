...
resource "aws_subnet" "management" {
  ...
  tags = {
    Name = "ACFW-2.0-MANAGEMENT-SUBNET-01"
    "Test Name" = "ACFW-2.0"
    "Test Type" = "Private"
  }
}
...
resource "aws_instance" "jump_server" {
  ami           = var.ami_ubuntu # Assuming Ubuntu for Jump Server
  instance_type = "t2.micro" # Or a suitable instance type
  subnet_id     = aws_subnet.management.id
...
module "axe_window_subnet_01_vm_01_eni" {
  source  = "./modules/eni"
...
module "axe_window_management_subnet_vm_01_eni" {
  source  = "./modules/eni"
...
module "axe_window_subnet_01_vm_02_eni" {
  source  = "./modules/eni"
...
module "axe_window_management_subnet_vm_02_eni" {
  source  = "./modules/eni"
...
module "axe_ubuntu_subnet_01_vm_03_eni" {
  source  = "./modules/eni"
...
module "axe_ubuntu_management_subnet_vm_03_eni" {
  source  = "./modules/eni"
...
module "axe_ubuntu_subnet_02_vm_01_eni" {
  source  = "./modules/eni"
...
module "axe_ubuntu_management_subnet_vm_01_eni" {
  source  = "./modules/eni"
...
module "axe_ubuntu_subnet_02_vm_02_eni" {
  source  = "./modules/eni"
...
module "axe_ubuntu_management_subnet_vm_02_eni" {
  source  = "./modules/eni"
...
module "chkp_window_subnet_01_vm_01_eni" {
  source  = "./modules/eni"
...
module "chkp_window_management_subnet_vm_01_eni" {
  source  = "./modules/eni"
...
module "chkp_window_subnet_01_vm_02_eni" {
  source  = "./modules/eni"
...
module "chkp_window_management_subnet_vm_02_eni" {
  source  = "./modules/eni"
...
module "chkp_ubuntu_subnet_01_vm_03_eni" {
  source  = "./modules/eni"
...
module "chkp_ubuntu_management_subnet_vm_03_eni" {
  source  = "./modules/eni"
...
module "chkp_ubuntu_subnet_02_vm_01_eni" {
  source  = "./modules/eni"
...
module "chkp_ubuntu_management_subnet_vm_01_eni" {
  source  = "./modules/eni"
...
module "chkp_ubuntu_subnet_02_vm_02_eni" {
  source  = "./modules/eni"
...
module "chkp_ubuntu_management_subnet_vm_02_eni" {
  source  = "./modules/eni"
...
module "fpnt_window_subnet_01_vm_01_eni" {
  source  = "./modules/eni"
...
module "fpnt_window_management_subnet_vm_01_eni" {
  source  = "./modules/eni"
...
module "fpnt_window_subnet_01_vm_02_eni" {
  source  = "./modules/eni"
...
module "fpnt_window_management_subnet_vm_02_eni" {
  source  = "./modules/eni"
...
module "fpnt_ubuntu_subnet_01_vm_03_eni" {
  source  = "./modules/eni"
...
module "fpnt_ubuntu_management_subnet_vm_03_eni" {
  source  = "./modules/eni"
...
module "fpnt_ubuntu_subnet_02_vm_01_eni" {
  source  = "./modules/eni"
...
module "fpnt_ubuntu_management_subnet_vm_01_eni" {
  source  = "./modules/eni"
...
module "fpnt_ubuntu_subnet_02_vm_02_eni" {
  source  = "./modules/eni"
...
module "fpnt_ubuntu_management_subnet_vm_02_eni" {
  source  = "./modules/eni"
...
module "ftnt_window_subnet_01_vm_01_eni" {
  source  = "./modules/eni"
...
module "ftnt_window_management_subnet_vm_01_eni" {
  source  = "./modules/eni"
...
module "ftnt_window_subnet_01_vm_02_eni" {
  source  = "./modules/eni"
...
module "ftnt_window_management_subnet_vm_02_eni" {
  source  = "./modules/eni"
...
module "ftnt_ubuntu_subnet_01_vm_03_eni" {
  source  = "./modules/eni"
...
module "ftnt_ubuntu_management_subnet_vm_03_eni" {
  source  = "./modules/eni"
...
module "ftnt_ubuntu_subnet_02_vm_01_eni" {
  source  = "./modules/eni"
...
module "ftnt_ubuntu_management_subnet_vm_01_eni" {
  source  = "./modules/eni"
...
module "ftnt_ubuntu_subnet_02_vm_02_eni" {
  source  = "./modules/eni"
...
module "ftnt_ubuntu_management_subnet_vm_02_eni" {
  source  = "./modules/eni"
...
module "jnpr_window_subnet_01_vm_01_eni" {
  source  = "./modules/eni"
...
module "jnpr_window_management_subnet_vm_01_eni" {
  source  = "./modules/eni"
...
module "jnpr_window_subnet_01_vm_02_eni" {
  source  = "./modules/eni"
...
module "jnpr_window_management_subnet_vm_02_eni" {
  source  = "./modules/eni"
...
module "jnpr_ubuntu_subnet_01_vm_03_eni" {
  source  = "./modules/eni"
...
module "jnpr_ubuntu_management_subnet_vm_03_eni" {
  source  = "./modules/eni"
...
module "jnpr_ubuntu_subnet_02_vm_01_eni" {
  source  = "./modules/eni"
...
module "jnpr_ubuntu_management_subnet_vm_01_eni" {
  source  = "./modules/eni"
...
module "jnpr_ubuntu_subnet_02_vm_02_eni" {
  source  = "./modules/eni"
...
module "jnpr_ubuntu_management_subnet_vm_02_eni" {
  source  = "./modules/eni"
...
module "panw_window_subnet_01_vm_01_eni" {
  source  = "./modules/eni"
...
module "panw_window_management_subnet_vm_01_eni" {
  source  = "./modules/eni"
...
module "panw_window_subnet_01_vm_02_eni" {
  source  = "./modules/eni"
...
module "panw_window_management_subnet_vm_02_eni" {
  source  = "./modules/eni"
...
module "panw_ubuntu_subnet_01_vm_03_eni" {
  source  = "./modules/eni"
...
module "panw_ubuntu_management_subnet_vm_03_eni" {
  source  = "./modules/eni"
...
module "panw_ubuntu_subnet_02_vm_01_eni" {
  source  = "./modules/eni"
...
module "panw_ubuntu_management_subnet_vm_01_eni" {
  source  = "./modules/eni"
...
module "panw_ubuntu_subnet_02_vm_02_eni" {
  source  = "./modules/eni"
...
module "panw_ubuntu_management_subnet_vm_02_eni" {
  source  = "./modules/eni"
...
module "swal_window_subnet_01_vm_01_eni" {
  source  = "./modules/eni"
...
module "swal_window_management_subnet_vm_01_eni" {
  source  = "./modules/eni"
...
module "swal_window_subnet_01_vm_02_eni" {
  source  = "./modules/eni"
...
module "swal_window_management_subnet_vm_02_eni" {
  source  = "./modules/eni"
...
module "swal_ubuntu_subnet_01_vm_03_eni" {
  source  = "./modules/eni"
...
module "swal_ubuntu_management_subnet_vm_03_eni" {
  source  = "./modules/eni"
...
module "swal_ubuntu_subnet_02_vm_01_eni" {
  source  = "./modules/eni"
...
module "swal_ubuntu_management_subnet_vm_01_eni" {
  source  = "./modules/eni"
...
module "swal_ubuntu_subnet_02_vm_02_eni" {
  source  = "./modules/eni"
...
module "swal_ubuntu_management_subnet_vm_02_eni" {
  source  = "./modules/eni"
...
module "sphs_window_subnet_01_vm_01_eni" {
  source  = "./modules/eni"
...
module "sphs_window_management_subnet_vm_01_eni" {
  source  = "./modules/eni"
...
module "sphs_window_subnet_01_vm_02_eni" {
  source  = "./modules/eni"
...
module "sphs_window_management_subnet_vm_02_eni" {
  source  = "./modules/eni"
...
module "sphs_ubuntu_subnet_01_vm_03_eni" {
  source  = "./modules/eni"
...
module "sphs_ubuntu_management_subnet_vm_03_eni" {
  source  = "./modules/eni"
...
module "sphs_ubuntu_subnet_02_vm_01_eni" {
  source  = "./modules/eni"
...
module "sphs_ubuntu_management_subnet_vm_01_eni" {
  source  = "./modules/eni"
...
module "sphs_ubuntu_subnet_02_vm_02_eni" {
  source  = "./modules/eni"
...
module "sphs_ubuntu_management_subnet_vm_02_eni" {
  source  = "./modules/eni"
...
module "vrsn_window_subnet_01_vm_01_eni" {
  source  = "./modules/eni"
...
module "vrsn_window_management_subnet_vm_01_eni" {
  source  = "./modules/eni"
...
module "vrsn_window_subnet_01_vm_02_eni" {
  source  = "./modules/eni"
...
module "vrsn_window_management_subnet_vm_02_eni" {
  source  = "./modules/eni"
...
module "vrsn_ubuntu_subnet_01_vm_03_eni" {
  source  = "./modules/eni"
...
module "vrsn_ubuntu_management_subnet_vm_03_eni" {
  source  = "./modules/eni"
...
module "vrsn_ubuntu_subnet_02_vm_01_eni" {
  source  = "./modules/eni"
...
module "vrsn_ubuntu_management_subnet_vm_01_eni" {
  source  = "./modules/eni"
...
module "vrsn_ubuntu_subnet_02_vm_02_eni" {
  source  = "./modules/eni"
...
module "vrsn_ubuntu_management_subnet_vm_02_eni" {
  source  = "./modules/eni"
...
module "wbtn_window_subnet_01_vm_01_eni" {
  source  = "./modules/eni"
...
module "wbtn_window_management_subnet_vm_01_eni" {
  source  = "./modules/eni"
...
module "wbtn_window_subnet_01_vm_02_eni" {
  source  = "./modules/eni"
...
module "wbtn_window_management_subnet_vm_02_eni" {
  source  = "./modules/eni"
...
module "wbtn_ubuntu_subnet_01_vm_03_eni" {
  source  = "./modules/eni"
...
module "wbtn_ubuntu_management_subnet_vm_03_eni" {
  source  = "./modules/eni"
...
module "wbtn_ubuntu_subnet_02_vm_01_eni" {
  source  = "./modules/eni"
...
module "wbtn_ubuntu_management_subnet_vm_01_eni" {
  source  = "./modules/eni"
...
module "wbtn_ubuntu_subnet_02_vm_02_eni" {
  source  = "./modules/eni"
...
module "wbtn_ubuntu_management_subnet_vm_02_eni" {
  source  = "./modules/eni"
...
module "cuda_window_subnet_01_vm_01_eni" {
  source  = "./modules/eni"
...
module "cuda_window_management_subnet_vm_01_eni" {
  source  = "./modules/eni"
...
module "cuda_window_subnet_01_vm_02_eni" {
  source  = "./modules/eni"
...
module "cuda_window_management_subnet_vm_02_eni" {
  source  = "./modules/eni"
...
module "cuda_ubuntu_subnet_01_vm_03_eni" {
  source  = "./modules/eni"
...
module "cuda_ubuntu_management_subnet_vm_03_eni" {
  source  = "./modules/eni"
...
module "cuda_ubuntu_subnet_02_vm_01_eni" {
  source  = "./modules/eni"
...
module "cuda_ubuntu_management_subnet_vm_01_eni" {
  source  = "./modules/eni"
...
module "cuda_ubuntu_subnet_02_vm_02_eni" {
  source  = "./modules/eni"
